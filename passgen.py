...
#максимально доппустимые числа !!
max_count_default = 1000000
max_count_main_default = 1000

#создание класса генерации пароля !!
class PassGen:
...
#функция для создания тхт файла!!

    def prompt(self, txt):
        return str(input(txt))
#задача вопросов для будующей генерации паролей!!
...
#в конце было добавлена функция которая сохраней тхт файл в папку проекта
